...
def get_cu_file_str(
    ...
    insts = "\n".join(
        [
            """template cudaError_t BatchPrefillWithRaggedKVCacheDispatched<{num_frags_x}, {head_dim}, {kv_layout}, {pos_encoding_mode}, {allow_fp16_qk_reduction}, {causal}, {dtype_in}, {dtype_out}, {idtype}>(
...
if __name__ == "__main__":
    pattern = (
        r"batch_ragged_prefill_head_([0-9]+)_layout_([0-9]+)_posenc_([0-9]+)_"
